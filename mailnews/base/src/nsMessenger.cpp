                           ...
                           nsIFile **aSaveAsFile)
{
  ...
  filePicker->Init(mWindow, saveMailAsStr, nsIFilePicker::modeSave, true);
...
nsMessenger::GetSaveToDir(nsIFile **aSaveDir)
{
  ...
  filePicker->Init(mWindow, chooseFolderStr, nsIFilePicker::modeGetFolder, true);
