...
pref("app.update.certs.1.issuerName", "");
pref("app.update.certs.1.commonName", "");

pref("app.update.certs.2.issuerName", "");
pref("app.update.certs.2.commonName", "");
...
#define AM_DOMAIN addons.epyrus.org
